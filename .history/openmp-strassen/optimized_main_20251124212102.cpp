...
void serialVerify(int n, const double* A, const double* B, double* C){
...
void printResults(int n, int threads, int threshold, int max_depth, int padded, 
                 double time, bool show_gflops = true) {
...
int main(int argc, char ** argv){
    ...
    double verify_time = verify_timer.elapse();
